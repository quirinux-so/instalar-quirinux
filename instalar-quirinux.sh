...
echo "
 ...
 | ó Ubuntu. Se sugiere leer el código antes de utilizar.           |
 --------------------------------------------------------------------"                                               
sleep 0.1
